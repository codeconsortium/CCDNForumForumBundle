Feature: User Category Traversal
	...
	Scenario: See Category list filtered by forum
        Given I am on "/en/forum/test_forum_f1/category/" 
          ...
          And I should not see "test_category_f3_c1"
		  And I should not see "test_category_f3_c2"
		  And I should not see "test_category_f3_c3"
        Given I am on "/en/forum/test_forum_f2/category/" 
          And I should not see "test_category_fn_c1"
		  And I should not see "test_category_fn_c2"
		  And I should not see "test_category_fn_c3"
		  ...
		  And I should not see "test_category_f3_c2"
		  And I should not see "test_category_f3_c3"
        Given I am on "/en/forum/test_forum_f3/category/" 
          And I should not see "test_category_fn_c1"
		  And I should not see "test_category_fn_c2"
		  And I should not see "test_category_fn_c3"
          And I should not see "test_category_f1_c1"
		  ...
		  And I should not see "test_category_f2_c2"
		  And I should not see "test_category_f2_c3"
          And I should see "test_category_f3_c1"
		  And I should see "test_category_f3_c2"
		  And I should see "test_category_f3_c3"
	...
	Scenario: See Category list filtered by forum and category show
        Given I am on "/en/forum/test_forum_f1/category/"
          ...
          And I should not see "test_board_f2_c1_b1"
          And I should not see "test_board_f2_c1_b2"
          And I should not see "test_board_f2_c1_b3"
        ...
        Given I am on "/en/forum/test_forum_f1/category/" 
          ...
          And I should not see "test_board_f1_c1_b2"
          And I should not see "test_board_f1_c1_b3"
          And I should see "test_board_f1_c2_b1"
          And I should see "test_board_f1_c2_b2"
        ...
        Given I am on "/en/forum/test_forum_f1/category/" 
          ...
          And I should see "test_board_f1_c3_b3"
          And I should not see "test_board_f2_c1_b1"
          And I should not see "test_board_f2_c1_b2"
          And I should not see "test_board_f2_c1_b3"
          And I should not see "test_board_f2_c2_b1"
        ...
        Given I am on "/en/forum/test_forum_f2/category/" 
          ...
          And I should not see "test_board_f2_c1_b2"
          And I should not see "test_board_f2_c1_b3"
          And I should see "test_board_f2_c2_b1"
          And I should see "test_board_f2_c2_b2"
          And I should see "test_board_f2_c2_b3"
          And I should not see "test_board_f2_c3_b1"
          And I should not see "test_board_f2_c3_b2"
          And I should not see "test_board_f2_c3_b3"
        Given I am on "/en/forum/test_forum_f2/category/" 
          ...
          And I should not see "test_board_f2_c2_b2"
          And I should not see "test_board_f2_c2_b3"
          And I should see "test_board_f2_c3_b1"
          And I should see "test_board_f2_c3_b2"
          And I should see "test_board_f2_c3_b3"
